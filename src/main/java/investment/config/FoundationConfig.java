...
public class FoundationConfig {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(FoundationConfig.class);
    ...
    public static void load() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(configPath))) {
            ...
            investFoundations = jsonObject
                    .entrySet()
                    .stream()
                    .map(json -> new InvestFoundation(json.getKey(), json.getValue().getAsString()))
